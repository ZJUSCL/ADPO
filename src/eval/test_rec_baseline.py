...
def main(args):
    ...
    for ds in test_datasets:
        ...
        # Process data
        for i in tqdm(range(0, len(messages), args.bsz), disable=rank != 0):
        ...
        if rank == 0:
            ...
            output_path = output_path_template.format(DATASET=ds, STEPS=args.steps)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Distributed evaluation of baseline REC model (SFT or vanilla).")
    ...
    parser.add_argument("--output_path", type=str,
                        default="./logs/rec_results_{DATASET}_baseline_{STEPS}.json",
                        help="Output path template. Supports {DATASET} and {STEPS} placeholders.")
